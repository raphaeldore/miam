...
namespace Miam.Web.UnitTests.Controllers.RestaurantTests
{
    ...
    {
        protected IEntityRepository<Domain.Entities.Restaurant> _restaurantRepository;
        ...
        {
            _restaurantRepository = Substitute.For<IEntityRepository<Domain.Entities.Restaurant>>();
